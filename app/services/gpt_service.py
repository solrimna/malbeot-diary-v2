                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "- 사건: 일어난 일이나 행동 (예: 야근, 첫출근, 이사, 필라테스, 헬스, 운동)\n"
                            ...
                            "6. 키워드가 없는 카테고리는 건너뛸 것. '없음'은 모든 카테고리에서 추출할 것이 전혀 없을 때만 단독으로 답할 것. 카테고리별 자리표시자로 '없음'을 쓰지 말 것\n"
                            "7. 일기에서 명시적으로 '안 했다', '못 했다', '빠졌다' 등 부정 표현과 함께 언급된 행동은 "
                            "'안함'을 붙여 표현할 것 (예: '운동을 못 갔어' → 운동안함, '밥을 못 먹었어' → 식사안함). "
                            "언급되지 않은 것은 절대 만들지 말 것\n"
                            "8. '~를 다녀왔다', '~를 했다', '~를 갔다' 등 동사와 함께 쓰인 명사(장소, 활동)는 명사만 추출할 것 "
                            "(예: '필라테스를 다녀왔다' → 필라테스)\n"
                            "9. 특정 활동이 언급된 경우 해당 활동과 함께 속하는 상위 카테고리도 추출할 것 (규칙 4의 예외). "
                            "예) 필라테스 → 필라테스, 운동 / 독감 → 독감, 건강 / 홍대 카페 → 카페, 만남\n"
                            "예시) 뿌듯함, 야근, 회사, 상사, 치킨, 퇴근길, 운동안함"
                        ),
                    },
                    {"role": "user", "content": diary_content},
                ],
                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "5. 운동, 식사, 공부, 수면 등 주요 활동이 언급된 경우 반드시 포함할 것\n"
